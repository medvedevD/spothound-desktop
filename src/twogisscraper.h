#ifndef TWOGISSCRAPER_H
#define TWOGISSCRAPER_H
...
class TwoGisScraper : public ScrapeTask {
    Q_OBJECT
public:
    explicit TwoGisScraper(QString query, QString city,
